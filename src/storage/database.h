...
class Database : public QObject {
  ...
  public:
     ...
     */
    std::expected<void, StorageError> open();
     ...
     */
    std::expected<void, StorageError> execute(const QString& sql);
     ...
     */
    std::expected<void, StorageError> addRecentFile(const QString& path);
     ...
     */
    std::expected<void, StorageError> clearRecentFiles();
     ...
     */
    std::expected<void, StorageError> removeRecentFile(const QString& path);
     ...
     */
    std::expected<void, StorageError> setDatabaseVersion(int version);
     ...
     */
    std::expected<void, StorageError> setControlInt(const QString& name, int value);
     ...
     * @param value Value to set
     */
    std::expected<void, StorageError> setPreference(const QString& name, const QString& value);
     ...
     */
    std::expected<void, StorageError> saveWindowGeometry(const QString& worldName,
     ...
     * @param worldName World name (key prefix)
     */
    std::expected<QRect, StorageError> loadWindowGeometry(const QString& worldName);
  ...
  private:
     ...
     */
    std::expected<void, StorageError> createSchema();
     ...
     */
    std::expected<void, StorageError> migrateSchema();
     ...
     */
    std::expected<bool, StorageError> columnExists(const QString& tableName,
