...
const tConfigurationNumericOption OptionsTable[] = {
    ...
    {"append_to_log_file", true, O(m_bAppendToLogFile), 0, 0, 0},
    ...
    {"log_lines", 0, O(m_nLogLines), 0, 500000, 0},
    {"log_notes", false, O(m_bLogNotes), 0, 0, 0},
    {"log_output", false, O(m_bLogOutput), 0, 0, 0},
    ...
    {"show_bold", true, O(m_bShowBold), 0, 0, OPT_UPDATE_VIEWS | OPT_UPDATE_OUTPUT_FONT},
