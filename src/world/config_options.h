...
inline constexpr int OPT_CUSTOM_COLOUR =
    0x000001; // colour number (add 1 to colour to save, subtract 1 to load)
...
inline constexpr int OPT_FIX_INPUT_WRAP = 0x1000000;      // if changed, input wrapping changed
inline constexpr int OPT_FIX_TOOLTIP_VISIBLE = 0x2000000; // if changed, tooltip visibility changed
inline constexpr int OPT_FIX_TOOLTIP_START = 0x4000000;   // if changed, tooltip delay changed
...
inline constexpr int OPT_MULTLINE = 0x000001;      // multi-line option (eg. world notes)
inline constexpr int OPT_KEEP_SPACES = 0x000002;   // preserve leading/trailing spaces
inline constexpr int OPT_PASSWORD = 0x000004;      // use base 64 encoding
inline constexpr int OPT_COMMAND_STACK = 0x000008; // this is the command stack character
inline constexpr int OPT_WORLD_ID = 0x000010;      // this is the world ID
