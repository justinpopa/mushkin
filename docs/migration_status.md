...
|:---|:---|:---|:---|:---|:---|:---|:---|:---|
| World | `src/world/` | 🟢 Complete | Yes (line buffer, MXP, logfile, notepad QPointer) | Yes (LoadImageMemory, compression) | Yes (WorldError for registry ops + notepad ops) | No | No | 0 (~11 Qt parent-child, MXP maps use qDeleteAll in CleanupMXP) |
