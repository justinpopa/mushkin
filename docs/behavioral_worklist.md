...
- [x] L80: commands -- Execute() doesn't check empty lines for reconnect prompt. Mushkin: src/world/world_document.cpp:1438
...
- [x] L82: speedwalks -- Speed walk prefix empty guard prevents all commands being parsed as speedwalks. Mushkin: src/world/world_document.cpp:1379-1380
- [x] L83: speedwalks -- RemoveBacktracks cannot cancel custom parenthesized directions. Mushkin: src/world/speedwalk_engine.cpp:409-439
...
- [x] L86: miniwindows -- WindowFont size=0 creates 1px font instead of defaulting to 10pt. Mushkin: miniwindow.cpp:1047
- [x] L87: miniwindows -- LoadImage accepts all Qt formats instead of only .bmp/.png. Mushkin: miniwindow.cpp:1217-1234
- [x] L88: miniwindows -- Arc atan2 conversion may draw wrong arc segment for some point configs. Mushkin: miniwindow.cpp:662-704
...
- [x] L92: arrays -- ArrayImport from table always returns eOK; original returns eImportedWithDuplicates. Mushkin: src/world/lua_api/world_arrays.cpp:599 (fixed in M146)
